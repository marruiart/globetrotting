...
import { NewExtUser, PaginatedExtUser, ExtUser, UserCredentials } from '../../models/globetrotting/user.interface';
...
export abstract class MappingService {
  ...
  public abstract mapUserCredentials(res: any): UserCredentials
