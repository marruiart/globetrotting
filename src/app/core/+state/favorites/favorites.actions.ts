...
export const addFavSuccess = createAction('[Favorites API] Add Favorite Success', props<{ fav: Fav }>());
...
export const deleteFavSuccess = createAction('[Favorites API] Delete Favorite Success', props<{ id: number | string }>());
