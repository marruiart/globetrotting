...
export const authReducer = createReducer(
    ...
    on(AuthAction.assignUserSuccess, (state, { user }) => ({ ...state, isLogged: true, role: user.role, user_id: (user.user_id as (Backend extends Firebase ? string : number)), error: null })),
