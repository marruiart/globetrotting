...
export abstract class DataService {
  ...
  public abstract updateField<T>(path: string, id: number | string, field: string, value: any, callback: (res: any) => T): Observable<T>;
  public abstract updateArray<T>(path: string, id: number | string, field: string, value: any, callback: (res: any) => T): Observable<T>;
